...
for recipe_line in full_recipe:
    ...
    if num_spaces > 1:
        ...
        if unit == "g":
            moderniser_recipe("{:.0f} g {}".format(amount, ingredient))
            continue
        amount = general_converter(amount, unit, unit_central, 1)
        if amount[1] == "yes":
            amount_2 = general_converter(amount[0], ingredient, food_dictionary, 250)
            ...
            if amount_2[1] == "yes":
                moderniser_recipe("{:.0f} g {}".format(amount_2[0], ingredient))
        ...
        moderniser_recipe("{} {} {}".format(amount, unit_ingredient))
        continue

    moderniser_recipe("{} {} {}".format(amount, unit, ingredient))
